...
module.exports = function BrowserRuntimeModule(webpack, acceptWeak) {
  ...
  class BrowserRuntimeModule extends RuntimeModule {
    ...
    generate() {
      ...
      const optionalChaining = this.compilation.outputOptions.environment.optionalChaining
      ...
      return Template.asString(
        [
          ...
          '}',
          acceptWeak
            ? `if (${module.exports.RuntimeGlobal}.e && (typeof self !== "object" || !self.addEventListener)) {`
            : '',
