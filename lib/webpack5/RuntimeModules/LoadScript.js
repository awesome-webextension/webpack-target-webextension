 ...
 */
module.exports = function LoadScriptRuntimeModule(webpack, supportDynamicImport, classicLoaderEnabled, acceptWeak) {
    ...
    generate() {
      const DynamicImportLoader =
        ...
        this.f('url, done, key, chunkId', [
          `if (url.startsWith(${RuntimeGlobals.publicPath})) url = runtime.runtime.getURL(url.slice(${RuntimeGlobals.publicPath}.length))`,
